...
forvalues i = 1(1)12  {
	...
	** if core data does not exist, make it
	...
	if _rc!=0 {
		...
		do ${progs}/1996/sip96w`i'.do sip96w`i' sipp96w`i' 

	}
}

* topical modules (only assets)
forvalues i =  3(3)12 {
	...
	** if topical module data does not exist, make it
	...
	if _rc!=0 {
		...
		do ${progs}/1996/sip96t`i'.do sip96t`i' sipp96t`i' 
	} 
